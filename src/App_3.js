//Given the solution code to the previous "Multistep Form" challenge you encountered earlier in the course, your job is to refactor the app to use useReducer to manage state instead 
//of useState.
